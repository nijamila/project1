...
# apps/currency/models.py ga helper method qo'shish
class Currency(models.Model):
    ...
    def get_rate_to(self, user, target_currency):
        """
        Foydalanuvchining kursiga qarab, self -> target_currency kursini beradi
        Agar self == target_currency bo'lsa 1 qaytaradi
        """
